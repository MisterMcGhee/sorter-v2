...
class RotatingAndCapturing(Rev01BaseState):
    ...
    def step(self) -> Optional[ClassificationChannelState]:
        ...
        # Crop is taken from EXACTLY the frame the bbox was computed against —
        # not from a fresh capture.latest_frame read. See known-issues note
        # "classification-crop-frame-skew" for the bug this prevents.
