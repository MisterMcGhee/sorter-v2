...
def _make_c3_wiggle_ctx(
    *,
    ...
    ch3_held: bool,
    ch3_exit_center_crossed: bool = False,
    ...
    return FeederTickContext(
        ...
        analysis=SimpleNamespace(
            ...
            ch2_exit_center_crossed=False,
            ch3_exit_center_crossed=ch3_exit_center_crossed,
        ),
...
class C3StationTests(unittest.TestCase):
    ...
    def test_exit_incident_published_when_bbox_center_crossed_exit_midpoint(self) -> None:
        ...
        station.run_exit_wiggle(
            _make_c3_wiggle_ctx(
                now_mono=0.0,
                ch3_exit_overlap=0.35,
                ch3_held=False,
                ch3_exit_center_crossed=True,
            )
        )
        station.run_exit_wiggle(
            _make_c3_wiggle_ctx(
